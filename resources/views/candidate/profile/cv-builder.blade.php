...
<div class="row">
    <div class="d-flex justify-content-end">
        <a href="#cvModal" role="button" class="btn btn-primary cv-preview" data-bs-toggle="modal">{{
    ...
    <div class="col-md-12 mt-5 shadow p-9 card">
        ...
        <div class="border-bottom border-danger my-5 border-2 d-flex justify-content-between ">
            <h5 class="mt-2 fs-2 text-info"><i
                    class="fas fa-user-graduate text-info p-3 border rounded-circle border-info me-3"></i>{{
        ...
        <div class="border-bottom my-5 border-danger border-2 d-flex justify-content-between">
            <h5 class="mt-2 fs-2 text-info"><i
                    class="fas fa-briefcase text-info p-3 border rounded-circle border-info me-3"></i>{{
        ...
        <div class="border-bottom my-5 border-danger border-2 d-flex justify-content-between">
            <h5 class="mt-2 fs-2 text-info"><i
                    class="fas fa-link text-info p-3 border rounded-circle border-info me-3"></i>{{
