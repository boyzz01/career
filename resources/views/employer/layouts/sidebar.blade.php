<div class="ps-xl-7 px-2 pe-xl-0 d-flex align-items-stretch">
    <ul class="horizontal-menu nav flex-row d-block d-xl-flex">
        ...
        <li class="nav-item {{ Request::is('employer/jobs*') ? 'active' : ''}}">
            <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('job.index') }}">
        ...
        <li
            class="nav-item d-none d-xl-grid dropdown dropdown-hover {{ Request::is('employer/transactions*','employer/manage-subscription*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-3 ps-2" aria-current="page" href="javascript:void(0)">
