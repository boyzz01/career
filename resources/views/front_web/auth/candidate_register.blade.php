                    ...
                    <div class="hero-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb  justify-content-center mb-0">
                                <li class="breadcrumb-item "><a href="{{route('front.home')}}" class="fs-18 text-gray">
                                        @lang('web.home')
                                    </a>
                                </li>
                ...
                <div class="col-xl-6 col-lg-8 mx-auto">
                    ...
                    <form method="POST" id="addCandidateNewForm" class="py-40 px-40 bg-gray">
                            ...
                            <div class="col-12 mb-4">
                                <div class="form-group row">
                                    <div class="col-sm-6 col-12 mb-3 mb-sm-0">
                                        <a href="{{route('candidate.register')}}" class="btn btn-success d-block">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control fs-14 text-gray br-10" name="first_name"
                                        id="candidateFirstName" placeholder="Enter first name" required>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control fs-14 text-gray br-10" name="last_name"
                                        id="candidateLastName" placeholder="Enter last name" required>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control fs-14 text-gray br-10" name="email"
                                        id="candidateEmail" placeholder="Enter email address" required>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" placeholder="Enter password"
                                        class="form-control fs-14 text-gray br-10" id="candidatePassword" required
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation"
                                        ...
                                        placeholder="Confirm password" required onkeypress="return avoidSpace(event)">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 mb-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="remember">
                                    ...
                                    <a href="{{ route('terms.conditions.list') }}" target="_blank">{{
                                        __('messages.setting.terms_conditions') }}</a>
                                    &
                                    <a href="{{ route('privacy.policy.list') }}" target="_blank">{{
                                        __('messages.setting.privacy_policy') }}</a>.
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-12 d-grid my-4">
                            <button type="submit" class="btn btn-secondary" id="btnCandidateSave"
                            ...
                            <div class="d-grid">
                                ...
                                <a href="{{ url('/login/google?type=1') }}"
                                    class="btn google-btn d-flex align-items-center justify-content-center mb-3"><i
                                        class="fa-brands fa-google fs-5 me-3"></i>{{
                                ...
                                <a href="{{ url('/login/linkedin?type=1') }}"
                                    class="btn linkedin-btn d-flex align-items-center justify-content-center"><i
                                        class="fa-brands fa-linkedin-in fs-5 me-3"></i>{{
