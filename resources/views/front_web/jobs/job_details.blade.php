                                ...
                                <div class="hero-desc d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="desc d-flex align-items-center me-lg-4 me-2 pe-2">
                                        ...
                                        <span class="text-gray mb-0">
                                            {{$job->currency->currency_icon}} {{numberFormatShort($job->salary_from).' -
                                            '.numberFormatShort($job->salary_to)}}</span>
                                    </div>
                                    @endif
                                </div>
                    ...
                    <div class="row align-items-lg-center">
                        ...
                        <div class="hero-desc d-flex flex-wrap">
                            ...
                            <div class="desc d-flex me-4 pe-2">
                                ...
                                $isJobApplicationShortlisted)
                                @if($isActive && !$job->is_suspended && \Carbon\Carbon::today()->toDateString() < $job->
                                    job_expiry_date->toDateString())
                                    <button
                                        class="btn {{ $isJobDrafted ? 'btn-outline-primary' : 'btn-outline-dark' }} "
                                        onclick="window.location='{{ route('show.apply-job-form', $job->job_id) }}'">
                                        {{ $isJobDrafted ? __('web.job_details.edit_draft') :
                                        __('web.job_details.apply_for_job') }}
                                    </button>
                                    @endif
                                    @else
                                    <button class="btn btn-outline-primary ml-2">{{
                                        __('web.job_details.already_applied') }}</button>
                                    @endif
                            </div>
                        </div>
                        @endrole
                            ...
                            <div class="hero-desc d-flex flex-wrap">
                                <div class="desc d-flex me-4 pe-2">
                                    <button class="btn btn-outline-dark mb-3"
                                        onclick="window.location='{{ route('candidate.register') }}'">{{
                                        __('web.job_details.register_to_apply') }}
                                    </button>
                                </div>
                                <div class="desc d-flex me-4 pe-2">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        {{ Session::get('warning') }}
                        <a href="{{ route('candidate.profile',['section'=> 'resume']) }}" class="alert-link ml-2 ">{{
                            __('web.job_details.click_here') }}</a> {{ __('web.job_details.to_upload_resume') }}
                        .
                    </div>
                </div>
                @endif
                    ...
                    <div class="row our-latest-jobs">
                                    ...
                                    <div class="col-sm-10 col-9 ps-lg-4 ms-xl-4 ms-lg-3">
                                        ...
                                        <div class="card-desc d-sm-flex mt-4 flex-wrap">
                                            ...
                                            <div class="d-flex me-sm-4">
                                                ...
                                                <p class="fs-14 text-gray">
                                                    {{ (!empty($relatedJob->full_location)) ? $relatedJob->full_location
                                                    : 'Location Info. not available.'}}</p>
                                            </div>
                                            <div class="d-flex me-sm-4">
                                                <i class="fa-solid fa-clock text-gray me-3 fs-18"></i>
                                                <p class="fs-14 text-gray">
                                                    {{$relatedJob->created_at->diffForHumans()}}</p>
                                            </div>
                                            @if($job->hide_salary=='0')
                                            <div class="d-flex">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-8 text-center">
                                <a href="{{ route('front.search.jobs') }}" class="btn btn-primary mb-40 mt-lg-4">
                ...
                <div class="col-lg-4">
                    <div class="job-desc-right br-10 px-40 bg-gray mb-40 mt-lg-0 mt-md-5 mt-4">
                        ...
                        <div class="desc-box d-flex justify-content-between mb-2">
                            <div class="d-flex align-items-center mb-3">
                                <i class="fa-solid fa-magnifying-glass text-primary me-2 fs-18"></i>
                                <p class="fs-14 text-secondary mb-0">
                                    @lang('messages.job.functional_area'):</p>
                            </div>
                            <p class="fs-14 text-gray text-end">
                                {{ html_entity_decode($job->functionalArea->name) }}</p>
                        </div>
                        @if($job->degreeLevel)
                        <div class="desc-box d-flex justify-content-between mb-2">
                            <div class="d-flex align-items-center mb-3">
                                <i class="fa fa-graduation-cap text-primary me-2 fs-18"></i>
                                <p class="fs-14 text-secondary mb-0">
                                    @lang('messages.job.degree_level'):</p>
                            </div>
                            <p class="fs-14 text-gray text-end">
                                {{ html_entity_decode($job->degreeLevel->name) }}</p>
                        </div>
                        @endif
                        <div class="desc-box d-flex justify-content-between mb-2">
                            <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="desc-box d-flex justify-content-between mb-2">
                            ...
                            <p class="fs-14 text-gray text-end">
                                {{ isset($job->experience) ? $job->experience .' '.
                                __('messages.candidate_profile.year') :'No experience' }}</p>
                        </div>
                        <div class="desc-box d-flex justify-content-between mb-2">
                            <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="desc-box">
                            ...
                            <div class="desc d-flex flex-wrap">
                                ...
                                <p
                                    class="fs-14 text-gray bg-white py-2 br-gray px-3 {{$loop->last?'':'me-4'}} rounded-3">
                    ...
                    <div class="company-overview br-10 px-40 bg-gray">
                        <h5 class="fs-18 text-secondary mb-4">
