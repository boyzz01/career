    ...
    <div class="d-flex flex-column">
        <div class="col-lg-9 mt-5">
            <form method="post" id="searchIsActiveHeaderSlider">
                @csrf
                {{-- <div--}} {{-- class="col-lg-6 col-sm-12 form-check form-switch col-sm d-block">--}}
                    {{-- <label class="switch-label">--}}
                        {{-- <input type="checkbox" name="is_active" --}} {{--
                            class="searchIsActiveHeaderSlider form-check-input" {{ ($settings['slider_is_active']==1)
                            ? 'checked' : '' }}>--}}
                        {{-- <span class=" switch-span"></span>--}}
                        {{-- </label>--}}
                    {{-- <span--}} {{-- class="pb-2 fs-5 text-gray-600 mb-3 mx-3 mb-md-0">{{
                        __('messages.image_slider.message') }}--}}
                        {{-- <i class="fas fa-question-circle ml-1" --}} {{-- data-bs-toggle="tooltip" --}} {{--
        ...
        <div class="mb-5 d-flex align-items-center">
            <div class="form-check form-switch mb-0">
                <input class="form-check-input searchIsActiveHeaderSlider" type="checkbox" name="is_active" {{
                    ($settings['slider_is_active']==1) ? 'checked' : '' }}>
            </div>
...
{{Form::hidden('header-extension-message',__('messages.image_slider.image_extension_message'),['id' =>
...
{{--@push('scripts')--}}
{{--
<script src="{{asset(mix('assets/js/header_sliders/header_sliders.js'))}}"></script>--}}
{{--@endpush--}}