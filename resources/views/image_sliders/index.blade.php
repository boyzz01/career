                    ...
                    <form method="post" id="searchIsActive" class="d-lg-flex m-6">
                        ...
                        <div class="col-lg-6 col-sm-12 mb-5 d-flex align-items-center">
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input isFullSlider" type="checkbox" name="is_active" {{
                                    ($settings['is_full_slider']==1) ? 'checked' : '' }}>
                            </div>
                            <label class="form-label fs-5 text-gray-600 me-5 mb-0 mb-1">
                                {{ __('messages.image_slider.slider') }}
                                <span data-bs-toggle="tooltip" title="{{ __('messages.image_slider.slider_title') }}">
                        ...
                        <div class="col-lg-6 col-sm-12 mb-5 d-flex align-items-center">
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input isSliderActive" type="checkbox" name="is_active" {{
                                    ($settings['is_slider_active']==1) ? 'checked' : '' }}>
                            </div>
                            <label class="form-label fs-5 text-gray-600 me-5 mb-0 mb-1">
...
'imageExtensionMessage'])}}
@endsection
{{--@push('scripts')--}}
{{--
<script src="{{asset(mix('assets/js/image_slider/image_slider.js'))}}"></script>--}}
{{--@endpush--}}