                    ...
                    <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuButton1">
                        ...
                        <div class="p-5">
                            ...
                            <div class="mb-5">
                                ...
                                {{ Form::select('employers', $companies,null, ['id' => 'filter_employers',
                                'data-control' =>'select2', 'class' => 'form-select status-selector
                                select2-hidden-accessible data-allow-clear="true"','placeholder' =>
                                __('messages.flash.select_employer')]) }}
                            </div>
                            <div class="d-flex justify-content-end">
                                <button class="btn btn-secondary"
                                    id="resetJobNotificationFilter">{{__('messages.common.reset')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--
<script src="{{asset(mix('assets/js/jobs/job_notification.js'))}}"></script>--}}
@endpush