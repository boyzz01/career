...
<div class="row mt-3">
    <div class="col-sm-12 my-0">
        ...
        {{ Form::textarea('address', $setting['address'], ['class' => 'form-control h-75', 'required','placeholder' =>
    ...
    <div class="col-sm-6">
        ...
        <span class="required"></span>
        <br>
        {{ Form::tel('phone', $setting['phone'], ['class' => 'form-control','onkeyup' => 'if (/\D/g.test(this.value))
        this.value = this.value.replace(/\D/g,"")' ,'required','id'=>'phoneNumber']) }}
    ...
    <div class="col-sm-6">
        ...
        <span class="required"></span>
        {{ Form::email('email', $setting['email'], ['class' => 'form-control', 'required', 'placeholder' =>
        __('messages.setting.email')]) }}
    </div>
</div>
<div class="mt-4 mb-5">
    <!-- Submit Field -->
