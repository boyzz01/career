    ...
    <div class="row">
        ...
        <i class="fas fa-question-circle ml-1  general-question-mark"></i>
                    ...
                    <label>
                        ...
                        {{ Form::file('logo',['id'=>'logo','class' => 'image-upload d-none', 'accept' => '.png, .jpg, .jpeg']) }}
                    </label>
                </span>
                        </div>
                    </div>
        ...
        <i class="fas fa-question-circle ml-1  general-question-mark"></i>
                    ...
                    <label>
                        <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                        {{ Form::file('footer_logo',['id'=>'footerLogo','class' => 'image-upload d-none', 'accept' => '.png, .jpg, .jpeg']) }}
                    </label>
                </span>
                        </div>
                    </div>
        ...
        <i class="fas fa-question-circle ml-1  general-question-mark"></i>
                    ...
                    <label>
                        <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                        {{ Form::file('favicon',['id'=>'favicon','class' => 'image-upload d-none', 'accept' => '.png, .jpg, .jpeg']) }}
                    </label>
                </span>
                        </div>
                    </div>
